<?php if ( get_field('leadership_grouping_title', 'options') ): ?>
	<h1><?php the_field('leadership_grouping_title', 'options'); ?></h1>
<?php endif; ?>
...
<div class="team-container clearfix">
	...
	$args = array(
		...
		'meta_value'  	=> 'Executive Leadership'
	);
...
<?php if ( get_field('team_grouping_title', 'options') ): ?>
	<h1><?php the_field('team_grouping_title', 'options'); ?></h1>
<?php endif; ?>
...
<?php if ( get_field('scientific_advisory_board_title', 'options') ): ?>
